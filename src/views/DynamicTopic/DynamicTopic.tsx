...
const DynamicTopic = () => {
  ...
  const fetchEdit = (values: editArticleInfo) => {
    /*修改动态专题*/
    http.post('/dynamic-topic/update', { topic_id: operationId, ...values }).then((result: any) => {
      search()
      setIsVisibleEdit(false)
  ...
  const fetchDelete = (values: String) => {
    /*删除动态专题*/
    http.post('/dynamic-topic/delete', { topic_id: values }).then((result: any) => {
      search()
      setIsVisibleEdit(false)
      ...
      <div className="card">
        ...
        >
          ...
          >
            ...
            <Form.Item label="专题名" name="name" rules={[{
              required: true,
              message: '请输入专题名！',
              whitespace: true
            }]}>
            ...
            <Form.Item label="专题名单词" name="en_name" rules={[{
              required: true,
              message: '请输入专题名单词！',
              whitespace: true
            }]}>
            ...
            <Form.Item label="专题图标地址" name="icon" rules={[{
              required: true,
              message: '请输入专题图标地址！',
              whitespace: true
            }]}>
            ...
            <Form.Item label="专题描述" name="description" rules={[{
              required: true,
              message: '请输入专题描述',
              whitespace: true
            }]}>
            ...
            <Form.Item label="首页显示" name="is_show" valuePropName="checked" rules={[{
              required: true,
              message: '请选择是否首页显示',
            }]}>
              <Switch />
            ...
            <Form.Item label="是否加入首页或者推荐" name="is_push" valuePropName="checked" rules={[{
              required: true,
